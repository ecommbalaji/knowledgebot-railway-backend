...
# R2 storage removed - signed-url and download endpoints removed
...
async def knowledgebase_file_delete_endpoint(
    ...
    Deletes a file from Gemini FileSearch and database.
    The file_name should be the database ID (UUID).
    """
    try:
